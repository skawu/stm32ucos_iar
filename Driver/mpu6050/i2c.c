...
unsigned char I2C_read(I2C_TypeDef * I2Cx, unsigned char val, size_t len, unsigned char addr)
{
    ...
    I2C_GenerateSTOP(I2Cx, ENABLE);
    while(!I2C_CheckEvent(I2Cx, uint32_t I2C_EVENT_MASTER_BYTE_RECEIVED));
